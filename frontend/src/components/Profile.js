...
const Profile = () => {
  ...
  const saveProfile = async () => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/${process.env.API_PREFIX}/user/me`, {
        method: 'PUT',
        headers: {
  ...
  const changeEmail = useCallback(async () => {
    ...
    try {
      ...
      if (emailChangeData.step === 'input') {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/${process.env.API_PREFIX}/auth/change-email/request`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
        ...
        const response = await fetch(`${process.env.REACT_APP_API_URL}/${process.env.API_PREFIX}/auth/change-email/verify`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  const disconnectTelegram = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/${process.env.API_PREFIX}/telegram/disconnect`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
