...
const EditRecurringIncomes = () => {
  ...
  const fetchIncomes = async () => {
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}`${API_PREFIX}/incomes`, {
        headers: {
  ...
  const handleDelete = async () => {
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}`${API_PREFIX}/incomes/${selectedIncome.id}?delete_all=true`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${auth.token}`
        }
  ...
  const handleUpdate = async (updatedIncome) => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}`${API_PREFIX}/incomes/${updatedIncome.id}`, {
        method: 'PUT',
        headers: {
